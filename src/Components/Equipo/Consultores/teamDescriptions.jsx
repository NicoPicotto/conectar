const teamDescriptions = [
   ...
   },
   {
      ...
      title: "Microbióloga",
      description:
         "Especialista en implementación de normas de gestión de la calidad e inocuidad. Amplio expertise en auditorías de proveedores.",
   },
   {
      name: "Matías Sebastián Carozzo",
      position: "Consultor",
